YUI(YUI3_config).add('ezsimplegallery', function (Y) {
    ...
    function eZSG(conf) {
        ...
        this.index = 0;
        this.userClicked=false; /* PTW - flag for click detection */
    ...
    eZSG.prototype._init = function () {
        ...
        this.next.on('click', function (e) {
            e.preventDefault();
            that.showNext();
            that.userClicked=true; /* PTW - flag for click detection */
        });
    ...
    /**
     * PTW - Scrolls to the next images if there's one AND IF NOT USER-CLICKED.
     */
    eZSG.prototype.iterateNext = function () {
