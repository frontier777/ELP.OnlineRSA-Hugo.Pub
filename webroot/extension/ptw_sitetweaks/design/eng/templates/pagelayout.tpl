...
{* START: PTW 2016-02-17 Adding REPEAT code for google analytics - to help detection by google, ref ACM 2016-02 *}
{literal}
...
fbq('init', '123091818307635'); // Insert your pixel ID here.
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=123091818307635&ev=PageView&noscript=1"
/></noscript>
{/literal}
{* END:PTW 2016-02-17 *}
</head>
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v2.9&appId=946137608745345";
